...
namespace WeatherApp.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string connectionString = Configuration.GetConnectionString("WeatherAppConnection");
            services.AddDbContext<WeatherAppDbContext>(option => option.UseSqlServer(connectionString));
